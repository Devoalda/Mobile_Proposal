...
\begin{longtable}{|c|p{7cm}|c|c|}
    ...
    \hline
    8 & User Following: Users can follow other users for a personalized feed of questions. & Medium & $\text{\rlap{$\checkmark$}}\square$\\
    \hline
    9 & Explore Page: A curated page showcasing a collection of questions for users to explore. & Low & $\text{\rlap{$\checkmark$}}\square$\\
    \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|p{5cm}|c|c|}
        ...
        \hline
        17 & AI-generated Answer Feature: Implement a feature to generate answers using AI. & 12 & $\text{\rlap{$\checkmark$}}\square$\\
        \hline
    \end{tabular}
\end{table}
